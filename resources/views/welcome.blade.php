			  ...
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/1411"
				  ...
				  <div class="card__title-wrap">
					...
					<div class="card__type">ポロシャツ</div>
				  </div>
				</a>
			  </div>
			...
			<li class="card card_set" data-id="1311" style="border:none;">
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/1311" title="スウェットs">
				  ...
				  <div class="card__title-wrap">
					<div class="card__title">sweatshirt</div>
					<div class="card__type">スウェット</div>
				  </div>
				</a>
			  </div>
			...
			<li class="card card_set" data-id="2902" style="border:none;">
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/2902" title="アウター">
				  ...
				  <div class="card__title-wrap">
					<div class="card__title">Outer</div>
					<div class="card__type">アウター</div>
				  </div>
				</a>
			  </div>
			...
			<li class="card card_set" data-id="3398" style="border:none;">
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/3398" title="Paper Coffee Cup">
				  ...
				  <div class="card__title-wrap">
					<div class="card__title">Bag</div>
					<div class="card__type">バッグ</div>
				  </div>
				</a>
			  </div>
			</li>
			...
			<li class="card card_set" data-id="2732" style="border:none;">
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/2732" title="Face Mask">
				  ...
				  <div class="card__title-wrap">
					<div class="card__title">Cap</div>
					<div class="card__type">キャップ</div>
				  </div>
				</a>
			  </div>
			</li>
			...
			<li class="card card_set" data-id="2902" style="border:none;">
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/2902" title="Snack Bar">
				  ...
				  <div class="card__title-wrap">
					<div class="card__title">towel</div>
					<div class="card__type">タオル</div>
				  </div>
				</a>
			  </div>
			...
			<li class="card card_set" data-id="1905" style="border:none;">
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/1905"
				  ...
				  <div class="card__title-wrap">
					<div class="card__title">club activities</div>
					<div class="card__type">部活</div>
				  </div>
				</a>
			  </div>
			</li>
			...
			<li class="card card_set" data-id="3398" style="border:none;">
			  <div class="card__inner">
				...
				<a class="card__link" href="https://yellowimages.com/object-mockups/set/3398" title="Paper Coffee Cup">
				  ...
				  <div class="card__title-wrap">
					<div class="card__title">emblem</div>
					<div class="card__type">エンブレム・ワッペン</div>
				  </div>
				</a>
