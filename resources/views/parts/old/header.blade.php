...
<head>
  ...
  <link rel="stylesheet" id="page-home-css" href="stylesheet2/app.css" type="text/css" media="all">
  <link rel="stylesheet" id="page-home-css" href="stylesheet2/home.css" type="text/css" media="all">
  <link rel="stylesheet" id="page-home-css" href="stylesheet2/orig.css" type="text/css" media="all">
...
<body class="ecommerce">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 additional-shop-info">
          <ul class="list-unstyled list-inline">
            <li><i class="fa fa-phone"></i><span>03-6458-2577</span></li>
            <!-- BEGIN CURRENCIES -->
        ...
        <div class="col-md-6 col-sm-6 additional-nav">
          <ul class="list-unstyled list-inline pull-right">
            <li><a href="shop-account.html">マイアカウント</a></li>
            <li><a href="shop-checkout.html">チェックアウト</a></li>
            <li><a href="page-login.html">ログイン</a></li>
          </ul>
        </div>
        <!-- END TOP BAR MENU -->
      </div>
  ...
  <div class="header">
    <div class="container">
      <a class="site-logo" href="shop-index.html"><img src="assets/corporate/img/logos/logo.png"
        ...
        <div class="top-cart-content-wrapper">
          <div class="top-cart-content">
            <ul class="scroller" style="height: 250px;">
              <li>
                <a href="shop-item.html"><img src="assets/pages/img/cart-img.jpg" alt="" width="37" height="34"></a>
