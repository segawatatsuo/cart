            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">プルダウンセット登録</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="setname" class="form-control" placeholder="">
                    </div>
                    ...
                    <div class="col-6 pt-3 pb-3">
                        ...
                        <div id="LeftSide" class="list-group col sortable">
                            ...
                            @foreach ($pulldowns as $pulldown)
                                <div class="list-group-item" data-id="{{ $n }}">{{ $pulldown->inside_name }}</div>
                                @php $n+=1; @endphp
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="col-6 pt-3 pb-3">
                        <label for="name">セット内容(左側からここにドラッグしてください)</label>
                        <div id="RightSide" class="list-group col sortable"></div>
