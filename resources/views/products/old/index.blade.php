                                                    ...
                                                    <div class="product__card">
                                                        <form action="/cart/index" method="post">
                                                            ...
                                                            <h2 class="h2 d-flex justify-content-between">
                                                                ...
                                                                <input id="item_price_total" class="" name="価格" value="0円" readonly>
                                                            </h2>
                                                            ...
                                                            -->
                                                                <button type="submit" class="pill pill_w100 pill_big pill_black product__actions-cart">カートに入れる</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
...
<!--ユニフォーム単価とオプション代金計算-->
    ...
    <script>
        let item_price = <?php echo $item_price; ?>;
        ...
        $(function() {
            $("select").change(function() {
                ...
                $("#item_price_total").val(total + item_price + "円");
