...
<template id="js-template1">
    ...
    <section id = "wrap1">
        ...
        <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
            <div class="d-flex">
                <button id="1" type="button" class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                    data-bs-target="#ColorSelectFontModal" data-block="1" style="margin-right: 4px;">
                    文字縁カラー
                </button>
        ...
        <div class="product__files" id="textbox">
            <div class="d-flex">
                ...
                <input type="text" value="" class="radi select2 textbox-grow" id="text1" data-block="1"
    ...
    <section id = "wrap2">
        ...
        <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
            <div class="d-flex">
                ...
                <input type="text" class="radi select2 textbox-grow" id="fontcolor_fuchidori2" name=""
    ...
    <template id="js-template3">
        ...
        <section id = "wrap3">
            ...
            <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
                <div class="d-flex">
                    <button id="3" type="button" data-block="3" class="btn btn-primary part btn-send w-50"
                        data-bs-toggle="modal" data-bs-target="#ColorSelectFontModal" data-whatever="3"
                        style="margin-right: 4px;">
                        文字縁カラー
                    </button>
                    <input type="text" class="radi select2 textbox-grow" id="fontcolor_fuchidori3" name=""
                        style="border: 1px solid #e2e5e9;" form="form1">
                </div>
            </div>
            ...
            <section id = "wrap6">
                ...
                <div class="product__files">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="addprint6"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="font6"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="fontcolor6"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="fuchidori_style">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="fuchidori6"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
                    <div class="d-flex">
                        <button id="6" type="button" data-block="6"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#ColorSelectFontModal" data-whatever="6" style="margin-right: 4px;">
                            文字縁カラー
                        </button>
                ...
                <div class="product__files" id="textbox">
                    <div class="d-flex">
                        <button id="6" type="button" data-block="6" class="btn btn-primary part w-50"
                            data-bs-toggle="" data-whatever="6" data-bs-target="" style="margin-right: 4px;">
                            テキスト
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="text6"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                </form>
            ...
            <section id = "wrap7">
                ...
                <div class="product__files">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="addprint7"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="7" type="button" data-block="7"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#FontSelectModal" data-whatever="7" style="margin-right: 4px;">
                            書 体
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="font7"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="7" type="button" data-block="7"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#ColorSelectModal" data-whatever="7" style="margin-right: 4px;">
                            文字カラー
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="fontcolor7"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="fuchidori_style">
                    <div class="d-flex">
                        <button id="7" type="button" data-block="7"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#FuchiDoriModal" data-whatever="7" style="margin-right: 4px;">
                            縁取り
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="fuchidori7"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
                    <div class="d-flex">
                        <button id="7" type="button" data-block="7"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#ColorSelectFontModal" data-whatever="7" style="margin-right: 4px;">
                            文字縁カラー
                        </button>
                ...
                <div class="product__files" id="textbox">
                    <div class="d-flex">
                        <button id="7" type="button" data-block="7" class="btn btn-primary part w-50"
                            data-bs-toggle="" data-whatever="7" data-bs-target="" style="margin-right: 4px;">
                            テキスト
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="text7"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                </form>
            ...
            <section id = "wrap8">
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="addprint" type="button" data-block="8"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#AddPrintModal" data-block="8" style="margin-right: 4px;">
                            プリント箇所
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="addprint8"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="8" type="button" data-block="8"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#FontSelectModal" data-whatever="8" style="margin-right: 4px;">
                            書 体
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="font8"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="8" type="button" data-block="8"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#ColorSelectModal" data-whatever="8" style="margin-right: 4px;">
                            文字カラー
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="fontcolor8"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="fuchidori_style">
                    <div class="d-flex">
                        <button id="8" type="button" data-block="8"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#FuchiDoriModal" data-whatever="8" style="margin-right: 4px;">
                            縁取り
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="fuchidori8"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
                    <div class="d-flex">
                        <button id="8" type="button" data-block="8"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#ColorSelectFontModal" data-whatever="8" style="margin-right: 4px;">
                            文字縁カラー
                        </button>
                        <input type="text" class="radi select2 textbox-grow" id="fontcolor_fuchidori8"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="textbox">
                    <div class="d-flex">
                        <button id="8" type="button" data-block="8" class="btn btn-primary part w-50"
                            data-bs-toggle="" data-whatever="8" data-bs-target="" style="margin-right: 4px;">
                            テキスト
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="text8"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                </form>
            ...
            <section id = "wrap9">
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="addprint" type="button" data-block="9"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#AddPrintModal" data-block="9" style="margin-right: 4px;">
                            プリント箇所
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="addprint9"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="9" type="button" data-block="9"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#FontSelectModal" data-whatever="9" style="margin-right: 4px;">
                            書 体
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="font9"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="9" type="button" data-block="9"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#ColorSelectModal" data-whatever="9" style="margin-right: 4px;">
                            文字カラー
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="fontcolor9"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="fuchidori_style">
                    <div class="d-flex">
                        <button id="9" type="button" data-block="9"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#FuchiDoriModal" data-whatever="9" style="margin-right: 4px;">
                            縁取り
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="fuchidori9"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
                    <div class="d-flex">
                        <button id="9" type="button" data-block="9"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#ColorSelectFontModal" data-whatever="9" style="margin-right: 4px;">
                            文字縁カラー
                        </button>
                        <input type="text" class="radi select2 textbox-grow" id="fontcolor_fuchidori9"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="textbox">
                    <div class="d-flex">
                        <button id="9" type="button" data-block="9" class="btn btn-primary part w-50"
                            data-bs-toggle="" data-whatever="9" data-bs-target="" style="margin-right: 4px;">
                            テキスト
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="text9"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                </form>
            ...
            <section id = "wrap10">
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="addprint" type="button" data-block="10"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#AddPrintModal" data-block="10" style="margin-right: 4px;">
                            プリント箇所
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="addprint10"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="10" type="button" data-block="10"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#FontSelectModal" data-whatever="10" style="margin-right: 4px;">
                            書 体
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="font10"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="fontcolor10"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="fuchidori_style">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="fuchidori10"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
                    <div class="d-flex">
                        ...
                        <input type="text" class="radi select2 textbox-grow" id="fontcolor_fuchidori10"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="textbox">
                    <div class="d-flex">
                        <button id="10" type="button" data-block="10" class="btn btn-primary part w-50"
                            data-bs-toggle="" data-whatever="10" data-bs-target="" style="margin-right: 4px;">
                            テキスト
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="text10"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                </form>
            ...
            <section id = "wrap11">
                ...
                <div class="product__files">
                    <div class="d-flex">
                        <button id="addprint" type="button" data-block="11"
                            class="btn btn-primary part btn-send w-50" data-bs-toggle="modal"
                            data-bs-target="#AddPrintModal" data-block="11" style="margin-right: 4px;">
                            プリント箇所
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="addprint11"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="font11"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="fontcolor11"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="fuchidori_style">
                    <div class="d-flex">
                        ...
                        <input type="text" value="" class="radi select2 textbox-grow" id="fuchidori11"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files fontcolor_fuchidori1" id="fontcolor_fuchidori">
                    <div class="d-flex">
                        ...
                        <input type="text" class="radi select2 textbox-grow" id="fontcolor_fuchidori11"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                ...
                <div class="product__files" id="textbox">
                    <div class="d-flex">
                        <button id="11" type="button" data-block="11" class="btn btn-primary part w-50"
                            data-bs-toggle="" data-whatever="11" data-bs-target="" style="margin-right: 4px;">
                            テキスト
                        </button>
                        <input type="text" value="" class="radi select2 textbox-grow" id="text11"
                            name="" style="border: 1px solid #e2e5e9;" form="form1">
                    </div>
                </div>
                </form>
